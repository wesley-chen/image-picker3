    ...
    <v-tab-item>
      <v-card flat>
        <v-list>
          <v-list-tile>
            <v-list-tile-content>
              <v-list-tile-title>Save image by</v-list-tile-title>
            </v-list-tile-content>
            <v-list-tile-action>
              <v-select
          ...
          <v-list-tile>
            <v-list-tile-content>
              <v-list-tile-title>Create sub folder by tab title</v-list-tile-title>
            </v-list-tile-content>
            <v-list-tile-action>
              <v-switch
          ...
          <v-list-tile>
            <v-list-tile-content>
              <v-list-tile-title>Ask where to save image in a new tab</v-list-tile-title>
            </v-list-tile-content>
            <v-list-tile-action>
          ...
          <v-list-tile>
            <v-list-tile-content>
              <v-list-tile-title>Ask where to save image when dragging to left</v-list-tile-title>
            </v-list-tile-content>
            <v-list-tile-action>
